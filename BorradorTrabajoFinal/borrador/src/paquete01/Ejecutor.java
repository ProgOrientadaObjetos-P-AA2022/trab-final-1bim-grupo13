...
import paquete05.LecturaConstructoras;
...
public class Ejecutor {
    ...
    public static void crearListaDeDatos(int opcion) {
        switch (opcion) {
            case 1:
                LecturaPropietario l1 = new LecturaPropietario("propietarios.dat");
                l1.establecerPropietarios();
                System.out.println(l1);
                l1.cerrarArchivo();
                break;

            case 2:
                LecturaBarrio l2 = new LecturaBarrio("barrios.dat");
                l2.establecerBarrios();
                System.out.println(l2);
                l2.cerrarArchivo();
                break;

            case 3:
                LecturaCiudad l3 = new LecturaCiudad("ciudades.dat");
                l3.establecerCiudades();
                System.out.println(l3);
                l3.cerrarArchivo();
                break;
            case 4:
                LecturaConstructoras l4 = new LecturaConstructoras("constructoras.dat");
                l4.establecerConstructoras();
                System.out.println(l4);
                l4.cerrarArchivo();
                break;

            case 5:
                LecturaCasa l5 = new LecturaCasa("casas.dat");
                l5.establecerCasa();
            ...
            case 6:
                LecturaDepartamento l6 = new LecturaDepartamento("departamentos.dat");
                l6.establecerDepartamento();
